# AGENTS.md - Kauthec do Brasil

## DO THIS FIRST

When opening this project folder in Codex, invoke the
...
Strategic phase: Codex Web (system prompt: web-design agent).
Build phase: Codex + `web-build` skill.
